...
<head>
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>CV</b>W</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>coronavirus</b>wonosobo</span>
    </a>
    ...
    <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">SRI RAHAYU</span>
            </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="nav-item menu-open">
          ...
          <a class="nav-link" href="{{ ('rezume') }}/index.html">  
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="https://adminlte.io">viruscoronawonosobo</a>.</strong> All rights
    reserved.
  </footer>
  <!-- Control Sidebar -->
...
<!-- Sparkline -->
<script src="{{asset('frontend')}}/bower_components/jquery-sp'arkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<script src="{{asset('frontend')}}{{asset('frontend')}}/h/dist/js/demo.js"></script>
</body>
</html>
